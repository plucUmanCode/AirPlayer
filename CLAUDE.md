...
companion/        # App .NET 10 (C#) — console d'abord, tray app plus tard
  src/
  tests/
shared/
...
### Compagnon .NET
- .NET 10, Windows d'abord (macOS plus tard si demandé).
